...
| **Checks: DoS** | GQL-007 depth, 008 complexity, 009 batch, **D01 alias amplification, D02 field duplication, D03 circular fragments, D04 directive overloading, D05 unbounded pagination, D06 cost-amplification oracle** | A | Depth uses latency heuristics (4×, ≥500ms) — noisy and evadable. GQL-D01–D06 now add structural alias-amplification, field-duplication, fragment-cycle, directive-overloading, schema-driven pagination-abuse, and an empirical cost-amplification oracle. Remaining gaps are persisted-query enforcement and introspection-as-DoS (GQL-D07–D08). |
