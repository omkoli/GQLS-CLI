...
| **Checks: DoS** | GQL-007 depth, 008 complexity, 009 batch, **D01 alias amplification, D02 field duplication, D03 circular fragments** | B+ | Depth uses latency heuristics (4×, ≥500ms) — noisy and evadable. GQL-D01/D02/D03 now add structural alias-amplification, field-duplication, and fragment-cycle signals. **Still missing: directive overloading.** These are cheap to add and are real CVEs. |
