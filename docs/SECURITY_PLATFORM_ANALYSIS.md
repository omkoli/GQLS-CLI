...
| **Checks: DoS** | GQL-007 depth, 008 complexity, 009 batch, **D01 alias amplification, D02 field duplication** | B | Depth uses latency heuristics (4×, ≥500ms) — noisy and evadable. GQL-D01/D02 now add structural alias-amplification and field-duplication signals. **Still missing: circular fragments, directive overloading.** These are cheap to add and are real CVEs. |
